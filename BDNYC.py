...
class BDNYCData:
    """Class to hold all of the target objects and methods for Brown Dwarf
    analysis."""
    ...
    def giveSpectrum(self, unum=None, otype=None, res=None, instr=None, date=None, \
                     snr=False, order=None, Filter=None):
        ...
        type = observation type, i.e. opt, nir, or mir
